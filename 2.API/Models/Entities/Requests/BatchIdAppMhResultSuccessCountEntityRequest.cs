...
namespace Models.Entities.Requests
{
    ...
    {
        public class BatchIdAppMhResultSuccessCountEntitySearchListRequest : BaseSearchModel
        {
            public BatchIdAppMhResultSuccessCountEntitySearchListFieldModelRequest? FieldModel { get; set; }
        }

        public class BatchIdAppMhResultSuccessCountEntitySearchListFieldModelRequest
        {
