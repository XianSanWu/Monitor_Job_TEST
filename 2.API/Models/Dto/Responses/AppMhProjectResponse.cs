...
{
    public class AppMhProjectResponse
    {
        public class AppMhProjectSearchListResponse : BaseModel
        {
            #region Properties
            /// <summary>  查詢結果[清單] </summary>
            //public List<AppMhProjectSearchResponse>? SearchItem { get; set; }
            #endregion

            public class AppMhProjectSearchResponse
            {
