...
namespace Models.Dto.Requests
{
    ...
    public class BatchIdAppMhResultSuccessCountRequest
    {
        public class BatchIdAppMhResultSuccessCountSearchListRequest : BaseSearchModel
        {
            public BatchIdAppMhResultSuccessCountSearchListFieldModelRequest? FieldModel { get; set; }
        }

        public class BatchIdAppMhResultSuccessCountSearchListFieldModelRequest
        {
